...
is a short way of representing a vector and is called the notation. Our
...
$$\ket{0}$$ or $$\ket{1}$$. In fact, they can be in linear combinations of
these states, also known as :
...
we try to read a qubit (also called ) we find that we retrieve directly
...
states . This is counter-intuitive and pretty far from what we observe
...
seen as a “list” of probabilities of its outcomes (more properly called
).
...
single bit. This means there is a sort of information encoded somewhere,
...
src="../../../assets/images/Bloch_sphere.svg.png" /></a>
